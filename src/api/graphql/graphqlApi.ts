...
export class GraphqlApi {
  ...
  constructor() {
    ...
    this.server = new ApolloServer(this.getApolloServerExpressConfig());
  }
  ...
  public init() {
    ...
    this.logger.info(
      `graphql server ready at port ${this.config.api.graphql.port}`,
    );
  }

  private getApolloServerExpressConfig(): ApolloServerExpressConfig {
    return {
      uploads: false,
